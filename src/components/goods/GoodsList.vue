<template>
  <div class="goods-list">
    ...
    <img :src="item.img_url" alt="" @error="show_default_image">
...
export default {
  ...
  methods:{
    ...
    show_default_image: function(event) {
        event.target.src = "https://img12.360buyimg.com/n7/jfs/t2653/35/258500432/98101/dcc1e439/570b9beeNfefb695d.jpg";
    },
  }
}
</script>
